...
namespace SmartOdyssey
{
    ...
    public static class SmartOdyssey_WorldLandmarks_AddLandmark_Patch
    {
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> codeInstructions)
        {
            var codes = codeInstructions.ToList();
            var check = AccessTools.Method(typeof(SmartOdyssey_WorldLandmarks_AddLandmark_Patch), "GetNumber");
        ...
        {
            return mutatorChance.chance * SmartOdyssey_Settings.landmarkMutatorMultiplier;
        }
